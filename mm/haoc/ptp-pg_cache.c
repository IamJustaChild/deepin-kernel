...
static inline bool __update_freelist(struct iee_cache *cache, void *freelist_old, void *freelist_new,
										unsigned long tid)
{
...
redo:
	...
	expend_num ++;
	pr_alert("gwm iee_cache_expand num %d , start_addr: 0x%lx, end_addr: 0x%lx, start_addr-end_addr: 0x%lx\n", expend_num,start_addr,end_addr,start_addr-end_addr);
	return 1;
}
#endif
