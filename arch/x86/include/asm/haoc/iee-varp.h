...
static void __maybe_unused iee_set_varp_modprobe_path(char *data, int maxlen, size_t len,
		char *buffer, size_t *lenp)
{
    iee_rw_gate(IEE_OP_SET_VARP_MODPROBE_PATH, data, maxlen, len, buffer, lenp);
}
#endif